...
# contour 는 연결된 외곽선이다.
#   edge가 경계선 이라면 
#   contour는 경계선을 따라 연결된 객체의 외곽
# contour을 사용하면 이미지 안에서 객체의 영역을 찾을 수 있다.
...
# contour를 하기전에 Canny 나 threshold로 경계영역 만들어야 한다.
...
#       (예 - 도넛을 인식하는경우 도넛 외곽과 가운데 구멍까지만 저장)
#   findContours함수의 두번째 반환값은 게층 정보가 반환된다.
